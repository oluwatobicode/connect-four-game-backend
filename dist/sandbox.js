...
async function runSimulation() {
    ...
    const simulatedMoves = [
        { player: "player1", col: 3 }, // P1 drops in 3
        { player: "player2", col: 4 }, // P2 drops in 4
        { player: "player1", col: 3 }, // P1 drops in 3
        { player: "player2", col: 5 }, // P2 drops in 5
        { player: "player1", col: 3 }, // P1 drops in 3
        { player: "player2", col: 1 }, // P2 drops in 1
        { player: "player1", col: 3 }, // P1 drops in 3 -> WIN!
    ];
